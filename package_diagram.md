...
### With Facade
- API -- Facad -- Models / Repositories
- The code is cleaner.
- The system is easier to test.
- Each layer stays separate.

---

## 4. Summary
- The diagram shows the three layers of the HBnB system.
- All communication goes through the Facade.
- This makes the architecture clean and easy to grow.
